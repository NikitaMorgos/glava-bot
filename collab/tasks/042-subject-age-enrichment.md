...
**[TECH]** — нет ожидаемых флагов. Чисто скриптовая функция, не меняет формат, не downstream-impact на агентов (GW игнорирует unknown fields).

**[PRODUCT]** — нет ожидаемых флагов. Универсальное обогащение, не специфично к Каракулиной.

**Оценка сложности:** `xs` (< 1 ч)
**Оценка риска:** `low`
