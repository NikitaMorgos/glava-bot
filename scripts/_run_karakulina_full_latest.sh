...
echo "[RUN] Approve fact_map checkpoint"
python scripts/checkpoint_save.py save karakulina fact_map /opt/glava/exports/test_fact_map_karakulina_v5.json --approve
