...
def write_article(post_id: int) -> dict:
    ...
    user_message = (
        f"Напиши статью для Яндекс Дзен на тему: «{post['topic']}»\n\n"
        "Структура:\n"
        "# Заголовок (цепляющий, без кликбейта)\n\n"
        "[Лид — 2–3 предложения, почему это важно]\n\n"
        "## Раздел 1\n[Текст]\n\n"
        "## Раздел 2\n[Текст]\n\n"
        "## Раздел 3 (опционально)\n[Текст]\n\n"
        "**Заключение** с мягким призывом к действию — заказать книгу или задуматься о семейной истории."
    )
